...
export let flashlightFrag = "precision mediump float;uniform float e;varying vec2 c;float i(float a){return 1.-a*a;}void main(){vec2 a=c-.5;float b=1.-i(distance(vec2(0,0),a/(.55*e)));gl_FragColor=vec4(0,0,0,b);}";
